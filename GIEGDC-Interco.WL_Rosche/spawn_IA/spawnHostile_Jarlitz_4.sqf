...
//[_zn,GROUPE_PARAMIL_moyen, nil, nil, nil, 0.1, 1] spawn int_fnc_spawnGarnisons;
...
[_zn, opfor, "rhsgref_ins_DSHKM", "O_G_Soldier_unarmed_F", 1, _probaManedFW, 1] spawn int_fnc_spawnFixedWeapons;