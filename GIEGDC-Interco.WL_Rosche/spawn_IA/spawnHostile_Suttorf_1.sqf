...
//[_zn,[2,3],GROUPE_PARAMIL_MOYEN,opfor] spawn int_fnc_spawnRdmPatrols;

//Spawn des garnisons
[_zn, _grpGarn, nil, nil, nil, 0.1, 0.2] spawn int_fnc_spawnGarnisons;
//[_zn,GROUPE_PARAMIL_GRAND, nil, nil, nil, 0.1, 0.2] spawn int_fnc_spawnGarnisons;
...
[_zn, opfor, "rhs_Igla_AA_pod_msv", "rhs_vmf_flora_rifleman", 1, _probaManedFW, 1] spawn int_fnc_spawnFixedWeapons;