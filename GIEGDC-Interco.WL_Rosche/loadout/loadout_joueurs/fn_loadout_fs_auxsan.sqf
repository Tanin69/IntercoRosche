...
this addItemToUniform "rhs_mag_20Rnd_556x45_M855A1_Stanag";
this addItemToVest "ACE_EntrenchingTool";
for "_i" from 1 to 11 do {this addItemToVest "rhs_mag_30Rnd_556x45_M855_Stanag_Pull";};
...
for "_i" from 1 to 8 do {this addItemToBackpack "ACE_splint";};
for "_i" from 1 to 9 do {this addItemToBackpack "rhs_mag_20Rnd_556x45_M855A1_Stanag";};
